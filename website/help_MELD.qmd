...
:::{.callout-warning}
Each time you connect, you should probably tell meld which data folder you'll be using by typing:
`/mnt/data/meld_graph/meldgraph.sh prepare_classifier.py`
Check the current data folder and if it is not the good one, type `n` and indicate your own data folder (e.g. `/mnt/data/meld_data_JJ` in this tuto)
:::
