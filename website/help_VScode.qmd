...
ssh -t %remote_username%@%remote_hostname% "srun --mem=16G --cpus-per-task=8 --time=08:00:00 --pty $SHELL -c '~/VSCode-linux-x64/bin/code tunnel'; bash"```
