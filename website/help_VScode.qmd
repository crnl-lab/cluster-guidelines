...
`ssh cluster_username@CRNLcluster` if you performed the SSH [tutorial](./help_ssh){target="_blank"}.

or

`ssh cluster_username@10.69.168.93` if you did not (in which case, you will have to enter your credentials each time you connect).
...
If you did not complete the SSH tutorial, replace CRNLcluster
